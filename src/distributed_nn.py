...
def add_fit_args(parser):
    ...
    parser.add_argument('--gather-type', type=str, default='gather', metavar='N',
                        help='gather/non to specify the type of comm used (MPI.Gather or point-to-point comm)')
    parser.add_argument('--enable-gpu', type=bool, default=False, help='whether to use gradient approx method')
    # TODO(hwang), check what's this
...
if __name__ == "__main__":
    ...
    if rank == 0:
        master_fc_nn = SyncReplicasMaster_NN(**kwargs_master)
